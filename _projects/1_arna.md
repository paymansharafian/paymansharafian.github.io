...
<p class="arna-scenario-intro">ARNA supports two primary operational scenarios, each with dedicated control strategies and interfaces. The <strong>Walker scenario</strong> covers physical human-robot interaction (pHRI), where a patient guides the robot as a mobility aid. The <strong>Sitter/Teleoperation scenario</strong> covers HRI tasks, where a patient or nurse controls the robot <a href="{{ '/projects/2_mpc_cbf/' | relative_url }}"><strong>remotely</strong></a>.</p>
...
<figure class="arna-figure">
  ...
  <figcaption class="arna-caption">Distributed software and networking architecture, covering sensors, instrumentation board, onboard PC (BlackBird), Jetson, and the Kinova arm communicating over Ethernet, USB, and Wi-Fi.</figcaption>
</figure>
<figure class="arna-figure">
  ...
  <figcaption class="arna-caption">Power and motor-control wiring, covering battery banks, inverter, instrumentation PCB, Sabertooth motor controllers, and the EtherCAT motor-control chain.</figcaption>
</figure>
